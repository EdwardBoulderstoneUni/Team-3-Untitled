...
enet_peer_queue_acknowledgement(ENetPeer* peer, const ENetProtocol* command, enet_uint16 sentTime)
{
	...
	if (command->header.channelID < peer->channelCount)
	{
		...
		if (reliableWindow >= currentWindow + ENET_PEER_FREE_RELIABLE_WINDOWS - 1 && reliableWindow <= currentWindow +
...
enet_peer_setup_outgoing_command(ENetPeer* peer, ENetOutgoingCommand* outgoingCommand)
{
	...
	peer->outgoingDataTotal += enet_protocol_command_size(outgoingCommand->command.header.command) + outgoingCommand->
		fragmentLength;
	...
	outgoingCommand->command.header.reliableSequenceNumber = ENET_HOST_TO_NET_16(
...
ENetOutgoingCommand*
enet_peer_queue_outgoing_command(ENetPeer* peer, const ENetProtocol* command, ENetPacket* packet, enet_uint32 offset,
                                 enet_uint16 length)
{
	ENetOutgoingCommand* outgoingCommand = enet_malloc(sizeof(ENetOutgoingCommand));
...
ENetIncomingCommand*
enet_peer_queue_incoming_command(ENetPeer* peer, const ENetProtocol* command, const void* data, size_t dataLength,
