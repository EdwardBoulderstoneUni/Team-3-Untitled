...
namespace NCL
{
	...
	{
	public:
		static Window* CreateGameWindow(std::string title = "NCLGL!", int sizeX = 800, int sizeY = 600,
		                                bool fullScreen = false, int offsetX = 100, int offsetY = 100);
    ...
    static const UserInterface* GetInterface() { return user_interface_; }
		...
		static RendererBase* GetRenderer() { return GetWindow()->renderer; }
